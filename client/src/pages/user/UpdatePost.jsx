...
// import { getOnePost, updatePost } from "../features/postSlice";
...
//       setCategory(singlePost.category?._id || singlePost.category || "");
//       setPreview(singlePost.imageUrl || null);
//     }
//   }, [singlePost]);
...
//                   <div className="mt-4">
//                     <img
//                       src={preview} // eski bo‘lsa eski, yangi tanlansa yangi chiqadi
//                       alt="Image Preview"
...
//                   <div className="mt-4">
//                     <img
//                       src={`${api.defaults.baseURL}/uploads/${singlePost.image}`}
//                       // src={preview}
//                       alt="Image Preview"
//                       className="w-32 h-32 object-cover rounded-lg shadow-sm"
//                     />
...
const UpdatePost = () => {
  ...
  useEffect(() => {
    if (singlePost) {
      ...
      setContent(singlePost.content || "");
      setCategory(singlePost.category?._id || singlePost.category || "");
      setPreview(`${api.defaults.baseURL}/uploads/${singlePost.image}`);
    }
  }, [singlePost]);
  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      ...
      // memory leak oldini olish uchun eski preview ni tozalash
